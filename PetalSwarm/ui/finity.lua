...
petalswarm.dark_theme = { -- dark
	...
	checkbox_checked = Color3.fromRGB(255, 255, 0),
	checkbox_outer = Color3.fromRGB(37, 34, 41),
	checkbox_inner = Color3.fromRGB(37, 34, 41),

	slider_color = Color3.fromRGB(255, 255, 0),
	...
	textbox_background = Color3.fromRGB(255, 255, 0),
	...
	dropdown_background = Color3.fromRGB(255, 255, 0),
	...
	button_background = Color3.fromRGB(255, 255, 0),
...
local mouse = petalswarm.gs["Players"].LocalPlayer:GetMouse()

function petalswarm:Create(class, properties)
...
function petalswarm:addShadow(object, transparency)
...
function petalswarm.new(isdark, gprojectName, thinProject)
	local petalswarmObject = {}
	local self2 = petalswarmObject
	local self = petalswarm

	if not petalswarm.gs["RunService"]:IsStudio() and self.gs["CoreGui"]:FindFirstChild(cachename) then
		warn("petalswarm:", "instance already exists in coregui!")
		
		return
	end

	local theme = petalswarm.theme
	local projectName = false
	local thinMenu = false
	
	if isdark == true then theme = petalswarm.dark_theme end
	...
	self2.ChangeToggleKey = function(NewKey)
		petalswarmData.ToggleKey = NewKey
		
		if not projectName then
			self2.tip.Text = "Press '".. string.sub(tostring(NewKey), 14) .."' to hide this menu"
		end
		
		if petalswarmData.UpConnection then
			petalswarmData.UpConnection:Disconnect()
		end

		petalswarmData.UpConnection = petalswarm.gs["UserInputService"].InputEnded:Connect(function(Input)
			if Input.KeyCode == petalswarmData.ToggleKey and not typing then
                toggled = not toggled
	...
	function self2:Category(name)
		...
		category.button = petalswarm:Create("TextButton", {
			Name = name,
		...
		category.container = petalswarm:Create("ScrollingFrame", {
			Name = name,
			BackgroundTransparency = 1,
		...
		category.hider = petalswarm:Create("Frame", {
			Name = "Hider",
			BackgroundTransparency = 0, --
			BorderSizePixel = 0,
			BackgroundColor3 = theme.main_container,
		...
		category.L = petalswarm:Create("Frame", {
			Name = "L",
		...
		if not thinProject then
			category.R = petalswarm:Create("Frame", {
				Name = "R",
				AnchorPoint = Vector2.new(1, 0),
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
		...
		if firstCategory then
			petalswarm.gs["TweenService"]:Create(category.hider, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
			petalswarm.gs["TweenService"]:Create(category.container, TweenInfo.new(0.3), {ScrollBarImageTransparency = 0}):Play()
		end
		
		do
			local uilistlayout = petalswarm:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder
			})
	
			local uilistlayout2 = petalswarm:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder
			})
		...
		category.button.MouseEnter:Connect(function()
			petalswarm.gs["TweenService"]:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play()
		end)
		category.button.MouseLeave:Connect(function()
			petalswarm.gs["TweenService"]:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 1}):Play()
		end)
			...
			for _, categoryf in next, self2.userinterface["Container"]["Categories"]:GetChildren() do
				if categoryf:IsA("ScrollingFrame") then
					if categoryf ~= category.container then
						petalswarm.gs["TweenService"]:Create(categoryf.Hider, TweenInfo.new(0.3), {BackgroundTransparency = 0}):Play()
						petalswarm.gs["TweenService"]:Create(categoryf, TweenInfo.new(0.3), {ScrollBarImageTransparency = 1}):Play()
					end
				end
			end

			petalswarm.gs["TweenService"]:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 0.2}):Play()
			petalswarm.gs["TweenService"]:Create(category.hider, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
			petalswarm.gs["TweenService"]:Create(category.container, TweenInfo.new(0.3), {ScrollBarImageTransparency = 0}):Play()
		...
		function category:Sector(name)
			...
			sector.frame = petalswarm:Create("Frame", {
				Name = name,
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
			...
			sector.container = petalswarm:Create("Frame", {
				Name = "Container",
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
			...
			sector.title = petalswarm:Create("TextLabel", {
				Name = "Title",
				Text = name,
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
			...
			function sector:Cheat(kind, name, callback, data)
				...
				cheat.frame = petalswarm:Create("Frame", {
					Name = name,
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 0, 25),
				...
				cheat.label = petalswarm:Create("TextLabel", {
					Name = "Title",
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 1, 0),
				...
				cheat.container	= petalswarm:Create("Frame", {
					Name = "Container",
				...
				if kind then
					if string.lower(kind) == "checkbox" or string.lower(kind) == "toggle" then
						...
						cheat.checkbox = petalswarm:Create("Frame", {
							Name = "Checkbox",
							AnchorPoint = Vector2.new(1, 0),
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.outerbox = petalswarm:Create("ImageLabel", {
							Name = "Outer",
							AnchorPoint = Vector2.new(1, 0.5),
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.checkboxbutton = petalswarm:Create("ImageButton", {
							AnchorPoint = Vector2.new(0.5, 0.5),
							Name = "CheckboxButton",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						if data then
							if data.enabled then
								petalswarm.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
								petalswarm.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
							end
						end
						...
						cheat.checkboxbutton.MouseEnter:Connect(function()
							...
							petalswarm.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = lightertheme}):Play()
						end)
						cheat.checkboxbutton.MouseLeave:Connect(function()
							if not cheat.value then
								petalswarm.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_outer}):Play()
							else
								petalswarm.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
							end
						end)
						cheat.checkboxbutton.MouseButton1Down:Connect(function()
							if cheat.value then
								petalswarm.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_outer}):Play()
							else
								petalswarm.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
							end
						end)
						cheat.checkboxbutton.MouseButton1Up:Connect(function()
							...
							if cheat.value then
								...
								petalswarm.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_outer}):Play()
								petalswarm.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_inner}):Play()
							end
						end)
                    ...
                    elseif string.lower(kind) == "color" or string.lower(kind) == "colorpicker" then
                        ...
                        cheat.hsvbar = petalswarm:Create("ImageButton", {
							AnchorPoint = Vector2.new(0.5, 0.5),
							Name = "HSVBar",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
                        ...
                        cheat.arrowpreview = petalswarm:Create("ImageLabel", {
                            Name = "ArrowPreview",
                            BackgroundColor3 = Color3.new(1, 1, 1),
                            BackgroundTransparency = 1,
                        ...
                        cheat.hsvbar.MouseButton1Down:Connect(function()
                            local rs = petalswarm.gs["RunService"]
                            local uis = petalswarm.gs["UserInputService"]local last = cheat.value;
                            ...
                            while uis:IsMouseButtonPressed'MouseButton1' do
                                ...
                                petalswarm.gs["TweenService"]:Create(cheat.arrowpreview, TweenInfo.new(0.1), {Position = UDim2.new(position, 0, 0.5, -6)}):Play()
                        ...
                        cheat.hsvbar.MouseButton2Down:Connect(function()
                            local rs = petalswarm.gs["RunService"]
                            local uis = petalswarm.gs["UserInputService"]
					...
					elseif string.lower(kind) == "dropdown" then
						...
						cheat.dropdown = petalswarm:Create("ImageButton", {
							Name = "Dropdown",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Size = UDim2.new(1, 0, 1, 0),
						...
						cheat.selected = petalswarm:Create("TextLabel", {
							Name = "Selected",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.list = petalswarm:Create("ScrollingFrame", {
							Name = "List",
						...
						uilistlayout = nil
						local uipadding = petalswarm:Create("UIPadding", {
							PaddingLeft = UDim.new(0, 2)
						})
						...
						local function refreshOptions()
							...
							for _, value in next, options do
								local button = petalswarm:Create("TextButton", {
									BackgroundColor3 = Color3.new(1, 1, 1),
									BackgroundTransparency = 1,
								...
								button.MouseEnter:Connect(function()
									petalswarm.gs["TweenService"]:Create(button, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text_hover}):Play()
								end)
								button.MouseLeave:Connect(function()
									petalswarm.gs["TweenService"]:Create(button, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text}):Play()
								end)
								...
								petalswarm.gs["TweenService"]:Create(button, TweenInfo.new(0), {TextTransparency = 1}):Play()
							end
							
							petalswarm.gs["TweenService"]:Create(cheat.list, TweenInfo.new(0), {Size = UDim2.new(1, 0, 0, 0), Position = UDim2.new(0, 0, 1, 0), CanvasSize = UDim2.new(0, 0, 0, cheat.list["UIListLayout"].AbsoluteContentSize.Y), ScrollBarImageTransparency = 1, BackgroundTransparency = 1}):Play()
						end
							...
							if cheat.dropped then
								for _, button in next, cheat.list:GetChildren() do
									if button:IsA("TextButton") then
										petalswarm.gs["TweenService"]:Create(button, TweenInfo.new(0.2), {TextTransparency = 0}):Play()
									end
								end

								petalswarm.gs["TweenService"]:Create(cheat.list, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, math.clamp(cheat.list["UIListLayout"].AbsoluteContentSize.Y, 0, 150)), Position = UDim2.new(0, 0, 1, 0), ScrollBarImageTransparency = 0, BackgroundTransparency = 0.5}):Play()
							else
								for _, button in next, cheat.list:GetChildren() do
									if button:IsA("TextButton") then
										petalswarm.gs["TweenService"]:Create(button, TweenInfo.new(0.2), {TextTransparency = 1}):Play()
									end
								end

								petalswarm.gs["TweenService"]:Create(cheat.list, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, 0), Position = UDim2.new(0, 0, 1, 0), ScrollBarImageTransparency = 1, BackgroundTransparency = 1}):Play()
							end
						end

						cheat.dropdown.MouseEnter:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.selected, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text_hover}):Play()
						end)
						cheat.dropdown.MouseLeave:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.selected, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text}):Play()
						end)
					...
					elseif string.lower(kind) == "textbox" then
						...
						cheat.background = petalswarm:Create("ImageLabel", {
							Name = "Background",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Size = UDim2.new(1, 0, 1, 0),
						...
						cheat.textbox = petalswarm:Create("TextBox", {
							Name = "Textbox",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.background.MouseEnter:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.textbox, TweenInfo.new(0.1), {TextColor3 = theme.textbox_text_hover}):Play()
						end)
						cheat.background.MouseLeave:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.textbox, TweenInfo.new(0.1), {TextColor3 = theme.textbox_text}):Play()
						end)
						cheat.textbox.Focused:Connect(function()
							typing = true

							petalswarm.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.textbox_background_hover}):Play()
						end)
						cheat.textbox.FocusLost:Connect(function()
							typing = false

							petalswarm.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.textbox_background}):Play()
							petalswarm.gs["TweenService"]:Create(cheat.textbox, TweenInfo.new(0.1), {TextColor3 = theme.textbox_text}):Play()
					...
					elseif string.lower(kind) == "slider" then
						...
						cheat.sliderbar = petalswarm:Create("ImageButton", {
							Name = "Sliderbar",
							AnchorPoint = Vector2.new(1, 0.5),
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.numbervalue = petalswarm:Create("TextLabel", {
							Name = "Value",
						...
						cheat.visiframe = petalswarm:Create("ImageLabel", {
							Name = "Frame",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.sliderbar.MouseButton1Down:Connect(function()
							...
							petalswarm.gs["TweenService"]:Create(cheat.visiframe, TweenInfo.new(0.1), {
								Size = UDim2.new(size / 150, 0, 1, 0),
								ImageColor3 = theme.slider_color_sliding
							}):Play()

							petalswarm.gs["TweenService"]:Create(cheat.numbervalue, TweenInfo.new(0.1), {
							...
							releaseconnection = petalswarm.gs["UserInputService"].InputEnded:Connect(function(Mouse)
					...
					elseif string.lower(kind) == "button" then
						...
						cheat.button = petalswarm:Create("TextButton", {
							Name = "Button",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Position = UDim2.new(0, 0, 0, 0),
						...
						cheat.button.MouseEnter:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.button_background_hover}):Play()
						end)
						cheat.button.MouseLeave:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.button_background}):Play()
						end)
						cheat.button.MouseButton1Down:Connect(function()
							petalswarm.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.button_background_down}):Play()
						end)
					...
					elseif string.lower(kind) == "keybind" or string.lower(kind) == "bind" then
						...
						cheat.button.MouseButton1Up:Connect(function()
							...
							connection = petalswarm.gs["UserInputService"].InputBegan:Connect(function(Input)
								if Input.UserInputType.Name == "Keyboard" and Input.KeyCode ~= petalswarmData.ToggleKey and Input.KeyCode ~= Enum.KeyCode.Backspace then
								...
								elseif Input.KeyCode == Enum.KeyCode.Backspace then
									...
									connection:Disconnect()
									connection = nil
								elseif Input.KeyCode == petalswarmData.ToggleKey then
						...
						petalswarm.gs["UserInputService"].InputBegan:Connect(function(Input, Process)
	...
	if not petalswarm.gs["RunService"]:IsStudio() then
